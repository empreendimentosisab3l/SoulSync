        ...
        <div className="min-h-screen bg-white text-gray-900 font-sans pb-20 overflow-x-hidden">
            ...
            <div className="container mx-auto px-4 pt-6 pb-8 max-w-lg flex flex-col items-center">
                ...
                <div className="w-full relative group">
                    ...
                    <div className="bg-white text-gray-900 rounded-3xl p-6 sm:p-8 border-4 border-teal-400 transform transition-transform group-hover:scale-[1.01] shadow-2xl relative overflow-hidden ring-4 ring-teal-50">
