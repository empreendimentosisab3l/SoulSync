      ...
      <div className="max-w-md mx-auto px-6 py-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 border-2 border-gray-200 rounded-2xl p-6 text-sm text-gray-700 space-y-4">
            ...
            <p>
              O Hypnozio foi desenvolvido com os melhores especialistas em hipnoterapia, cada um contribuindo com sua experiência única para garantir a eficácia de cada sessão.
            </p>
