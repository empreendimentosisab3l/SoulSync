    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-2xl mx-auto px-6 py-8">
        ...
        <button
          ...
          className="w-full py-4 bg-soul-purple text-white rounded-full font-bold text-lg transition-all duration-300 hover:bg-soul-lavender hover:scale-105 mb-3 shadow-lg"
        >
          Pague agora
        </button>
        ...
        <button
          ...
          className="w-full py-4 bg-gradient-to-r from-soul-peach to-soul-rose text-white rounded-full font-bold text-lg transition-all duration-300 hover:scale-105 mb-4 shadow-lg border-2 border-soul-rose"
        >
